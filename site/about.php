...
<head>
    ...
    <title>Fur-Store About Us</title>
</head>
    ...
    <header class="header">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active dropdown-toggle" href="about.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                About
                            </a>
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components links">
                ...
                <li>
                    <a href="latest.php"><i class="bx bx-book-open mr-3"></i> New Arrivals</a>
                </li>
                <li>
