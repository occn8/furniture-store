    ...
    ?>
            <section id="product" class="py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="<?php echo $item['product_image'] ?? "assets/products/armchairs/b_ARFLEX-Armchair-arflex.jpg" ?>" alt="product" class="img-fluid">
                        ...
                        <div class="col-sm-6 py-5">
                            ...
                            <small>by <?php echo $item['product_brand'] ?? "Brand"; ?></small>
                            <div class="d-flex">
                            ...
                            <table class="my-3">
                                ...
                                <tr class="font-rale font-size-14">
                                    <td>Deal Price:</td>
                                    <td class="font-size-20 text-danger">UGX <span><?php echo $item['product_price'] ?? 0; ?></span>/=<small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                                </tr>
                                <tr class="font-rale font-size-14">
                                    <td>You Save:</td>
